...
/*Создать экземпляр класса User
 с конкретными значениями свойств
и клонировать его в новую переменную.
 Свойствам нового экземпляра присвоить
новые значения. Сравнить полученные
экземпляры класса.
*/
?>
<!DOCTYPE html>
...
class WaterCar extends Car
{
    ...
    $managerOne = clone $personOne;
    $managerTwo = clone $personTwo;
    $managerTwo->name='Karim';
  ...
  //$toyota->showModel();
   echo "</pre>";
   echo $managerOne->name;//Narim
   echo $managerTwo->name;//Karim
